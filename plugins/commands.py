...
async def start(client, message):
    buttons = [
    [
        InlineKeyboardButton("🔥 ADMIN 🔥", url='https://t.me/cunongdan'),
    ],
    [
        InlineKeyboardButton('👥 Group', url='https://t.me/DaoNuNhi'),
        InlineKeyboardButton('Channel 📢', url='https://t.me/DaoPhuNu'),
    ],
    [
...
async def show_help(client, message):
    buttons = [
        ...
        [
            InlineKeyboardButton('🔰 XEM THÊM 🔰', url='https://t.me/sanbolac'),
